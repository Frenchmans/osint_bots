...
download_link = types.InlineKeyboardButton(text="📎 Скачать PDF (5.2MB)", url="")
inline_manual.add(download_link)

inline_about = types.InlineKeyboardMarkup()
off_link = types.InlineKeyboardButton(text="🌍 Официальный сайт", url="")
vk_link = types.InlineKeyboardButton(text="⛓ Вконтакте", url="")
facebook_link = types.InlineKeyboardButton(text="⛓ Facebook", url="")
